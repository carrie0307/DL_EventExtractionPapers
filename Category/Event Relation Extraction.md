...
* COLING2020: **KnowDis: Knowledge Enhanced Data Augmentation for Event Causality Detection via Distant Supervision**
    * url: [https://aclanthology.org/2020.coling-main.135/](https://aclanthology.org/2020.coling-main.135/)

* ACL2021: **Knowledge-Enriched Event Causality Identification via Latent Structure Induction Networks**
    * url: [https://aclanthology.org/2021.acl-long.376/](https://aclanthology.org/2021.acl-long.376/)

* ACL2021: **LearnDA: Learnable Knowledge-Guided Data Augmentation for Event Causality Identification**
    * url: [https://aclanthology.org/2021.acl-long.276/](https://aclanthology.org/2021.acl-long.276/)
...
* ACL2021: **Improving Event Causality Identification via Self-Supervised Representation Learning on External Causal Statement**
    * url: [https://aclanthology.org/2021.findings-acl.190/](https://aclanthology.org/2021.findings-acl.190/)
...
* [Event Causality Identification with Causal News Corpus -- Shared Task 3, CASE 2022](https://arxiv.org/abs/2211.12154)
    * [ARGUABLY @ Causal News Corpus 2022: Contextually Augmented Language Models for Event Causality Identification](https://preview.aclanthology.org/emnlp-22-ingestion/2022.case-1.20.pdf)
    * [Event Causality Identification with Causal News Corpus - Shared Task 3, CASE 2022](https://preview.aclanthology.org/emnlp-22-ingestion/2022.case-1.28.pdf)


### Doc-level ECI

* NAACL2019: **Modeling Document-level Causal Structures for Event Causal Relation Identification/**
...
* Dataset1: [EventStoryLine-v0.9 (ESC)](https://aclanthology.org/W17-2711.pdf)
    *  22 topics, 258 documents, 5,334 events, 7,805 intra-sentence and 62,774 inter-sentence event pairs (1,770 and 3,885 of them are annotated with causal relations respectively)
    * Data link: https://github.com/cltl/EventStoryLine/tree/master/annotated_data
    * sentence- & doc-level

* Dataset2: [Causal-TimeBank (CTB)](https://aclanthology.org/C14-1198.pdf)
    * 184 documents, 6813 events, and318 causal event pairs 
    * Data link: https://github.com/paramitamirza/Causal-TimeBank
    * sentence- & doc-level


* Dataset3: [EventStoryLine v1.5 (ESC v1.5)](https://aclanthology.org/W18-4306/)
    * The updated version of ESC v0.9, which contains 1,204 sentences and 7,778 event pairs, covering 22
news topics
    * Data link: https://github.com/tommasoc80/EventStoryLine/tree/master/annotated_data/v1.5,334
    * Related paper: [Event Causality Identification via Derivative Prompt Joint Learning](https://aclanthology.org/2022.coling-1.200.pdf)

* Dataset4: [BECAUSE](https://aclanthology.org/W17-0812/)
    * 5380 sentences, and 1803 causal event pairs
    * Data link: https://github.com/duncanka/BECAUSE
    Related paper: [Event Causality Identification via Derivative Prompt Joint Learning](https://aclanthology.org/2022.coling-1.200.pdf)

* Dataset5: [Causal News Corpus](https://aclanthology.org/2022.lrec-1.246/)
    * Datalink: https://github.com/tanfiona/CausalNewsCorpus
...
* SIGIR2022: **Towards Event-level Causal Relation Identification**
    * url: [https://dl.acm.org/doi/abs/10.1145/3477495.3531758](https://dl.acm.org/doi/abs/10.1145/3477495.3531758)
